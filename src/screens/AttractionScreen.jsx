...
function AttractionScreen({ attraction, onBack, onAddToPlan, existingEntry, }) {
    ...
    const sortedAccoms = (0, react_1.useMemo)(() => [...attraction.accommodations].sort((a, b) => a.pricePerNight - b.pricePerNight), [attraction]);
    ...
    const selectedAccomData = attraction.accommodations.find((a) => a.id === selectedAccom);
