...
export default function WelcomeScreen() {
  return (
    <ScreenContainer>
      <ImageBackground
        source={{ uri: "https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=1200&auto=format&fit=crop" }}
        style={styles.background}
        resizeMode="cover"
      >
        <LinearGradient
          colors={["rgba(58,90,64,0.9)", "rgba(58,90,64,0.55)", "rgba(62,50,38,0.35)", "rgba(62,50,38,0.94)"]}
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.headline}>
            Plan South Africa.{"\n"}
            <Text style={styles.headlineAccent}>Prices first, surprises never.</Text>
          </Text>
          ...
          <TouchableOpacity style={styles.primaryButton} activeOpacity={0.85} onPress={() => router.push("/create-account")}>
            <Text style={styles.primaryButtonText}>Create a free account</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.secondaryButton} activeOpacity={0.85} onPress={() => router.push("/sign-in")}>
            <Text style={styles.secondaryButtonText}>Sign in</Text>
          </TouchableOpacity>

          <Text style={styles.footer}>South Africa travel planning · Free forever</Text>
        </View>
      </ImageBackground>
    </ScreenContainer>
  );
...
const styles = StyleSheet.create({
  ...
  brandIcon: { width: 34, height: 34, borderRadius: 10, backgroundColor: colors.clay, alignItems: "center", justifyContent: "center" },
  ...
  featureRow: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(62,50,38,0.55)", borderRadius: 14, paddingVertical: 14, paddingHorizontal: 16 },
